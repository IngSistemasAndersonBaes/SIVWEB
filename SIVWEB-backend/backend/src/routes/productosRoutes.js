...
router.get('/productos', auth, authorizeAreas('Almacen'), (req, res, next) => {
...
router.get('/producto', auth, authorizeAreas('Almacen'), validateQuery(productQuerySchema), (req, res, next) => {
...
router.post('/productos', auth, authorizeAreas('Almacen'), validateBody(productSchema), (req, res, next) => {
...
router.put('/productos/:codigo', auth, authorizeAreas('Almacen'), validateBody(productUpdateSchema), (req, res, next) => {
...
router.delete('/productos/:producto', auth, authorizeAreas('Almacen'), (req, res, next) => {
